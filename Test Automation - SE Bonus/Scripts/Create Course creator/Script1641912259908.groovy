...
WebUI.click(findTestObject('Page_Group10 Administration Users Permissions Assign system roles/a_Course creator'))

WebUI.click(findTestObject('Page_Group10 Administration Users Permissions Assign system roles/option_Nguyen Nga (coursecreator1email.com)'))
