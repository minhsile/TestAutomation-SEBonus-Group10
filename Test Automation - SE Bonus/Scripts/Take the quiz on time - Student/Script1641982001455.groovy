...
WebUI.click(findTestObject('Object Repository/Page_Course Test Automation/a_Quiz1'))

WebUI.click(findTestObject('Object Repository/Page_TA Quiz1/a_Attempt quiz'))

WebUI.click(findTestObject('Object Repository/Page_Quiz1/input_Time limit_submitbutton'))
...
WebUI.click(findTestObject('Object Repository/Page_Quiz1 Attempt summary/input_Once you submit, you will no longer b_5f1420'))

WebUI.click(findTestObject('Object Repository/Page_Quiz1 Attempt review/a_Finish review'))

WebUI.click(findTestObject('Object Repository/Page_TA Quiz1/a_NH'))

WebUI.click(findTestObject('Object Repository/Page_TA Quiz1/a_Log out'))
