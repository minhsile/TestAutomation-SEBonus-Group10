...
WebUI.click(findTestObject('Page_Group10 Administration Users Permissions Assign system roles/a_Non-editing teacher'))

WebUI.click(findTestObject('Page_Group10 Administration Users Permissions Assign system roles/option_Tran Lam (noneditingteacher1email.com)'))
...
WebUI.setText(findTestObject('Object Repository/Page_Home page Log in to the site/input_Username_username'), 'noneditingteacher1')
