...
WebUI.click(findTestObject('Page_Course Test Automation/Add a URL/icon URL'))

WebUI.setText(findTestObject('Page_Course Test Automation/Add a URL/input_Name_name'), 'Introduce course')

WebUI.setText(findTestObject('Page_Course Test Automation/Add a URL/input_External URL_externalurl'), 'https://www.youtube.com/watch?v=jNxUnXahFcg&ab_channel=FITHCMUS')

WebUI.click(findTestObject('Page_Course Test Automation/Add a URL/submitbutton'))

WebUI.click(findTestObject('Page_Course Test Automation/Add a URL/a_Introduce course  URL'))

WebUI.click(findTestObject('Page_Course Test Automation/Add a URL/a_httpswww.youtube.comwatchvjNxUnXahFcgab_channelFITHCMUS'))
