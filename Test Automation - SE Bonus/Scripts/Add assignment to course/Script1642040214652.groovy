...
WebUI.click(findTestObject('Page_Course Test Automation/span_Add an activity or resource'))

WebUI.click(findTestObject('Page_Course Test Automation/img_Recommended_icon icon activityicon'))

WebUI.setText(findTestObject('Page_Course Test Automation/Page_Editing Assignment/input_name-assignment'), 'Bonus assignment')

WebUI.setText(findTestObject('Page_Course Test Automation/Page_Editing Assignment/input_description_assignment'), 'MSSV.zip/rar')
