...
WebUI.uploadFile(findTestObject('Object Repository/Page_Group10 Administration Users Accounts _c9beb9/input_Attachment_repo_upload_file'), 
    'D:\\TestAutomation-SEBonus-Group10\\manager.csv')
...
WebUI.click(findTestObject('Page_Group10 Administration Users Permissio_fb4295/a_Manager'))

WebUI.click(findTestObject('Page_Group10 Administration Users Permissions Assign system roles/option_Le Thu Thao (lttfitus.edu.vn)'))

WebUI.click(findTestObject('Page_Group10 Administration Users Permissions Assign system roles/option_Nguyen Hoang Dung (nhdfitus.edu.vn)'))

WebUI.click(findTestObject('Page_Group10 Administration Users Permissions Assign system roles/option_Nguyen Thi Thu Hang (ntthfitus.edu.vn)'))
