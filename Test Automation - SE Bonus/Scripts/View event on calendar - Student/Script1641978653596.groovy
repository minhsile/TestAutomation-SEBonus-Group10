...
WebUI.click(findTestObject('Object Repository/Page_Dashboard/span_19'))

WebUI.click(findTestObject('Object Repository/Page_Group10 Calendar Day view Wednesday, 1_465f57/a_Go to activity'))
