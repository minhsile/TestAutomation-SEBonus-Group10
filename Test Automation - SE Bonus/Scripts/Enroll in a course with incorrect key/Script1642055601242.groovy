...
WebUI.setText(findTestObject('Self enroll course/input_Enrolment key_enrolpassword'), '12345')

WebUI.click(findTestObject('Self enroll course/input_Enrolment key_submitbutton'))

WebUI.verifyTextPresent('Incorrect enrolment key, please try again', false)
