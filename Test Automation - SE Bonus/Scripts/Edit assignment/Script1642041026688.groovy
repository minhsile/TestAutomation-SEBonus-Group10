...
WebUI.click(findTestObject('Page_Course Test Automation/btn-setting-assignment'))

WebUI.click(findTestObject('Page_Course Test Automation/span_Edit settings'))

WebUI.setText(findTestObject('Page_Course Test Automation/Page_Editing Assignment/input_name-assignment'), 'Bonus assignment (Extend 1 week)')

WebUI.selectOptionByValue(findTestObject('Page_Course Test Automation/Page_Editing Assignment/set-deadline'), '27', false)
