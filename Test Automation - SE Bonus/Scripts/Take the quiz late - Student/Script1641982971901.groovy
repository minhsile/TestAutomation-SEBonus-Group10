...
WebUI.click(findTestObject('Object Repository/Page_Course Test Automation/a_Quiz2'))

WebUI.click(findTestObject('Object Repository/Page_TA Quiz2/a_Attempt quiz'))

WebUI.click(findTestObject('Object Repository/Page_Error/button_Continue'))

WebUI.click(findTestObject('Object Repository/Page_TA Quiz2/a_NH'))

WebUI.click(findTestObject('Object Repository/Page_TA Quiz2/a_Log out'))
