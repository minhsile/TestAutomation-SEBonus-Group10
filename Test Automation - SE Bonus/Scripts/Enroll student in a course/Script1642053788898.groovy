...
WebUI.click(findTestObject('Page_Course Test Automation/Enroll student/a_Participants'))
...
WebUI.click(findTestObject('Page_Course Test Automation/Enroll student/button_Enrol users'))
